...
const file_v1_user_service_proto_rawDesc = "" +
	"\n" +
	"\x15v1/user_service.proto\x12\auser.v1\x1a\rv1/user.proto2K\n" +
	"\vUserService\x12<\n" +
	"\aGetUser\x12\x17.user.v1.GetUserRequest\x1a\x18.user.v1.GetUserResponseB\x11Z\x0facme/gen/userv1b\x06proto3"
